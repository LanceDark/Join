...
function validatePriority() {
    ...
    priorityButtons.forEach(btn => {
        if (btn.classList.contains('urgently-selected') || btn.classList.contains('medium-selected') || btn.classList.contains('low-selected')) {
...
function showRequiredMessageTitle() {
    const titleWrapper = document.querySelector('.add-task-modal-headline-wrapper');
...
function showRequiredMessageDescription() {
    const descriptionWrapper = document.querySelector('.add-task-description-textarea');
    const descriptionRequiredMessage = document.querySelector('.description-message');
...
function showRequiredMessageAssignees() {
    const assigneeWrapper = document.querySelector('.add-task-assigned-to-input-wrapper');
